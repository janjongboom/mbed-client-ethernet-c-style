...
#ifndef __MBED_CLIENT_ETHERNET_WRAPPER_H__
#define __MBED_CLIENT_ETHERNET_WRAPPER_H__
...
public:
    ...
    void set_registered_function(mbed::util::FunctionPointer0<void> onRegistered) {
        _onRegistered = onRegistered;
    }

    void set_unregistered_function(mbed::util::FunctionPointer0<void> onUnregistered) {
